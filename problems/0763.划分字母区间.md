...
class Solution{
    ...
    public  List<Integer> partitionLabels(String s) {
        ...
        //sorting後，就會得到一組如果leetcode 452 - Minimum Number of Arrows to Burst Balloons的Input data.
        //Input: partitions = [[10,16],[2,8],[1,6],[7,12]]
        //之後就能按照之前處理重疊區間的解法來應對這題
        //可以自行在leetcode上打印觀察
